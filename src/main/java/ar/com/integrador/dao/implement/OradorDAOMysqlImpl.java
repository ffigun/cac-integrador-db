...
public class OradorDAOMysqlImpl implements iOradorDAO {
	...
	public Orador getById(Long id) throws Exception {
		...
		// metodo estatico, lo usamos a traves de la clase de conexion, este method
		// retorna un objeto conection,
		...
		if (resultset.next()) {
			...
			// *Orador(Long id_orador, String nombre, String apellido,String mail,String
			// tema,String activo)*/
...
//		String sql = "DELETE FROM oradores WHERE id_orador=" + id;
	...
	public void deleteOrador(Orador orador) throws Exception {
		...
		// Primero, busca el orador basado en la información proporcionada (por ejemplo,
